...
- Jump-diffusion simulators (`JumpDiffusionParams`, `simulate_merton_jump_diffusion`, etc.) now live in `src/jump_diffusion.py` and are still re-exported here for backwards compatibility.
